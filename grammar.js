...
var grammar = {
    ...
    {"name": "for_loop", "symbols": ["for_loop$string$1", {"literal":"("}, "for_init", {"literal":";"}, "_", "expression", {"literal":";"}, "_", "counter", {"literal":")"}, {"literal":"{"}, "block", {"literal":"}"}]},
    {"name": "for_init", "symbols": ["assignment"]},
    {"name": "for_init", "symbols": ["declaration"]},
    ...
    {"name": "while_loop", "symbols": ["while_loop$string$1", {"literal":"("}, "expression", {"literal":")"}, {"literal":"{"}, "block", {"literal":"}"}]},
